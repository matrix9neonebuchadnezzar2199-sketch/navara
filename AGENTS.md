...
`skills/` holds distilled best practices for working with Navara: [navara-usage](skills/navara-usage/SKILL.md) (how to use `@navaramap/three` — for application code, examples, and docs snippets), [navara-add-example](skills/navara-add-example/SKILL.md), and [navara-add-docs-example](skills/navara-add-docs-example/SKILL.md).
